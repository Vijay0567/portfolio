...
const revealElements = document.querySelectorAll('.skill-category, .project-card, .about-card, .cert-card, .edu-card, .timeline-content, .timeline-item');
...
if (typeof particlesJS !== "undefined") {
  particlesJS("particles-js", {
    particles: {
      ...
      color: { value: ["#38bdf8", "#0ea5e9", "#60a5fa", "#6366f1"] },
      shape: { type: "circle", stroke: { width: 0, color: "#000000" } },
      opacity: { value: 0.4, random: true, anim: { enable: true, speed: 1, opacity_min: 0.1 } },
      size: { value: 4, random: true, anim: { enable: true, speed: 4, size_min: 0.5 } },
...
const magneticElements = document.querySelectorAll(".magnetic, .btn-primary, .btn-outline, .skill-tag, .project-tech span");
